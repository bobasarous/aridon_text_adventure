...
def race_(race_description_choice):
    # Dwarf
    if race_description_choice == 0:
        race_description = """Dwarves are a hardy folk, shout and stout, strong and loyal, they live deep in mountains and
    ...
    # Elf
    if race_description_choice == 1:
        race_description = """Elves are a very slender race of people, they are agile in quick in both physical and mental tasks, they
    ...
    # Human
    if race_description_choice == 2:
        race_description = """Humans are anything they want to be, they live short lives compared to the other people of aridon, and
    ...
    # Loxodon
    # if race_description_choice == 4:
    #     race_description = "The loxodon of Aridon are an ancient race, in fact some believe they are the oldest race, but they are rare
    ...
    # Half-Orcs
    if race_description_choice == 3:
        race_description = """Orcs are a chaotic race, but unlike in most other settings, in Aridion Orcs, while still very aggressive,
    ...
    # Tieflings
    if race_description_choice == 4:
        race_description = """Tieflings aren't actually their own full on race, they are more like a strong blooded ethnicity among humans
...
def classes_(class_description_choice):
    # "Bard", "Cleric", "Druid", "Paladin", "Warlock"

    # Bard
    if class_description_choice == 0:
        class_description = """Bard"""

    # Cleric
    if class_description_choice == 1:
        class_description = """Cleric"""

    # Druid
    if class_description_choice == 2:
        class_description = """Druid"""

    # Paladin
    if class_description_choice == 3:
        class_description = """Paladin"""

    # Warlock
    if class_description_choice == 4:
        class_description = """Warlock"""

    return class_description


def backgrounds_(bg_choice):
    # "Acolyte", "Charlatan", "Criminal", "Entertainer", "Folk Hero", "Guild Artisan", "Hermit",
    # "Noble", "Outlander", "Sage", "Sailor", "Soldier", "Urchin"

    if bg_choice < 0 or bg_choice > 0:
        print("Fuck you")
